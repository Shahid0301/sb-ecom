...
public class MyGlobalExceptionHandler {
    ...
    public ResponseEntity<APIResponse> myResourceNotFoundException(ResourceNotFoundExcepiton e){
    ...
    public ResponseEntity<APIResponse> myAPIExeption(APIException e){
        String message=e.getMessage();
        APIResponse apiResponse=new APIResponse(message,false);
